...
const NBTBlock = ({ nbt }) => {
    ...
    return (
        <>
            <button onClick={() => setOpen(!isOpen)} type="button" className={"flex items-center justify-between w-full p-2 font-medium text-left text-gray-500 border border-b-0 border-gray-400 bg-gray-300 hover:bg-gray-100 transition-all duration-500 mx-auto " + (isOpen ? "rounded-t-lg w-[100%]" : "rounded-lg w-[10%]")}>
                <span>Show NBT</span>
